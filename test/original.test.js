...
describe('Clean Code Metrics for original_gilded_rose.js', () => {

  // Adjust the path to your actual file location
  const sourceCode = readSourceCode('../src/original_gilded_rose.js');

  test('Cyclomatic complexity of original_gilded_rose.js should not exceed 30', () => {
    const complexity = measureCyclomaticComplexity(sourceCode);
    console.log(`Cyclomatic Complexity of original_gilded_rose.js: ${complexity}`);
    expect(complexity).toBeLessThanOrEqual(30);  // You can adjust this threshold
  });

  test('Lines of code in original_gilded_rose.js should not exceed 200', () => {
    const loc = measureLinesOfCode(sourceCode);
    console.log(`Lines of Code in original_gilded_rose.js: ${loc}`);
